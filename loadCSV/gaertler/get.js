module.exports = {
    ...
    get: function (req, res) {
        ...
        let loadFromFile = '../../Datenbank/MasterlisteGarten20181102.csv';//MasterlisteGarten20181102.csv'; 
        let myJsonResponse = [];
        let stream = null;
        try {
            console.log('es wird das lasen der masterliste csv datei versucht')
